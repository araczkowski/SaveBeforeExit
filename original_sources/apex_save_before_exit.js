...
$.widget('ui.apex_save_before_exit', {
   ...
   _create: function() {
      ...
      if (uiw.options.ignoreModificationsSelector === undefined
         || uiw.options.ignoreModificationsSelector === null
      ) {
   ...
   _disableWarningTemp: function() {
      ...
      setTimeout(function(){uiw.enableWarning();}, uiw.options.disableTime);// Use closure to re-enable shortly.
